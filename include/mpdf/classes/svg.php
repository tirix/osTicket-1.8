...
//	
//	cette class etendue est open source, toute modification devra cependant etre repertoriŽe~
// NB UNITS - Works in pixels as main units - converting to PDF units when outputing to PDF string
// and on returning size
class SVG {
	var $svg_gradient;	//	array - contient les infos sur les gradient fill du svg classŽ par id du svg
...
function Arcto($x1, $y1, $x2, $y2, $rx, $ry, $angle, $largeArcFlag, $sweepFlag) {
	...
	//	 le cercle est tracŽ grave a 4 bezier cubic, les poitn de controles
	...
	function ImageSVG($data){
		...
		if(!function_exists("xml_svg2pdf_start")){
			function xml_svg2pdf_start($parser, $name, $attribs){
				...
				//
				//insertion des path et du style dans le flux de donnŽ general.
